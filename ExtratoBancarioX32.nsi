...
; Geral
Name "Extrato Bancário 0.0.1"
OutFile "Instaladores\ExtratoBancario-0.0.1-x32"
Unicode True
...
Section ExtratoBancario
	...
	; Painel de Controle
	WriteRegStr HKCU "SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\ExtratoBancario" "DisplayName" "Extrato Bancário 0.0.1.0"
	...
	WriteRegStr HKCU "SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\ExtratoBancario" "DisplayVersion" "0.0.1.0"
	WriteRegDWORD HKCU "SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\ExtratoBancario" "VersionMajor" 0
	WriteRegDWORD HKCU "SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\ExtratoBancario" "VersionMinor" 2
	WriteRegDWORD HKCU "SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\ExtratoBancario" "NoModify" 1
	WriteRegDWORD HKCU "SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\ExtratoBancario" "NoRepair" 0
	WriteRegDWORD HKCU "SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\ExtratoBancario" "EstimatedSize" 46227 ;KB
SectionEnd
